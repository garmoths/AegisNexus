...
def _normalize_tr(text: str) -> str:
    """Türkçe aksan karakterlerini ASCII'ye dönüştür (eşleşme sorunu önlenir)"""
...
class PhishingMLModel:
    ...
    def _train_model(self):
        phishing = [
            ...
            "Tebrikler! iPhone 15 kazandiniz. Hemen tikla: http://odul-iphone.tk",
            ...
            # --- Turkcce aksanli gercekci ornekler ---
            "Hesabınız askıya alındı. Lütfen doğrulama yapın: https://garanti-guvenlik.net/dogrula?token=8f3k",
            "AKBANK: Hesabınıza tanımsız cihazdan giriş yapıldı. Hemen doğrulayın: https://akbank-guvenlik.xyz/hesap-dogrula",
            "PTT KARGO: Gönderiniz teslim edilemedi. 14,90 TL ödeme: https://ptt-kargo-odeme.top/islem?id=TR88291047",
            "SGK: 1.247 TL prim borcunuz var. Ödeme: https://edevlet-sgk-sorgula.net/borc-odeme",
            "Kripto portföyünüze 0.47 BTC ödül tanımlandı. Çekim için 350 TL aktivasyon: https://btc-kazanc-platform.xyz/cek",
            "Hesabınız 24 saat içinde kapatılacak. Linke tıklayın: https://garanti-bbva-help.xyz/dogrula",
            "Şifreni hemen değiştir! Giriş: https://akbank-hesap.net/giris",
            "Kargonuz bekleniyor. 15 TL ödeme için tıklayın: https://ptt-kargo.top/pay",
            "Hesabınız geçici kısıtlandı. Doğrulama: https://isbank-guvenlik.net/onay",
            "e-Devlet: TC kimlik doğrulamanuz bekleniyor: https://edevlet-portal-tr.com/kimlik",
            "Garanti BBVA: Şüpheli işlem tespit edildi. İptal için: https://garanti-islem.xyz/iptal",
            "Ziraat Bankası: Kartınız bloke oldu. Aktifleştirme: https://ziraat-kart.net/aktif",
            "ACIL: BTC hesabınıza 0.5 BTC yırım geliri. Çekim için: https://bitcoin-odul.xyz/cek?ref=TR",
            "Yakında hesabınız silinecek. Hemen giriş yapın: https://instagram-guvenlik.xyz/verify",
            "MNG KARGO: Paketiniz ücretsiz teslimata hazır. Adres güncelleyin: https://mng-kargo.top/adres",
            "Vodafone: Faturanız ödenmemiş. Ödeme için: https://vodafone-fatura.net/odeme",
            "Netflix: Ödemeniz başarısız. Kart bilgilerini güncelleyin: https://netflix-billing.xyz/update",
            "Apple ID: Hesabınız kilitlendi. Doğrulama: https://apple-id-tr.top/verify",
            "Tebrikler! Üyelik ödülünüz: 500 TL. Almak için arayin: +90 532 901 44 21",
            "Amazon: Siparişiniz bekliyor. Ödeme onayı: https://amazon-tr.xyz/odeme-onayla",
            "Turkcell: Hatınız askıya alınacak. Doğrulama: https://turkcell-dogrulama.net/hat",
            "Hepsiburada: Kargonuz geldi. Teslim almak için: https://hepsiburada-kargo.top/teslim",
            "Trendyol: Ödeme sorun tespit edildi. Kart güncelleme: https://trendyol-odeme.xyz/kart",
            "Sosyal Sigortalar: Emeklilik başvurunuz onaylanmadı. Başvuru: https://sgk-emeklilik.net/basvuru",
            "WhatsApp: Hesabınız başka cihazda açıldı. Dogrulama: https://whatsapp-guvenlik.xyz/onayla",
            # --- SMS phishing ---
            "AKBANK: Hesabiniza tanimsiz cihazdan giris yapildi. 2 saat icinde dogrulamazsiniz hesabiniz kapatilacak. https://akbank-guvenlik.xyz/hesap-dogrula",
            "PTT KARGO: Gonderiniz TR88291047 teslim edilemedi. 14,90 TL odeme: https://ptt-kargo-odeme.top/islem",
            "ACIL BILDIRIM: Kripto portfoyunuze 0.47 BTC odul tanimlandi. Cekim: https://btc-kazanc-platform.xyz/cek",
            "Garanti BBVA: Hesabiniza yetkisiz erisim. Dogrulama: https://garanti-guvenlik.net/dogrula",
            # --- Scam / sosyal muhendislik ---
            "Tebrikler! Cekilis kazandiniz. Arayin: 0900 123 45 67",
            "Siz secildiniz! 1.000.000 TL odul. Hemen arayin: 0532 999 88 77",
        ...
        safe = [
            ...
            # Guvenli Turkce aksanli metinler
            "Yarın toplantı saat 10:00'da. Katılır mısın?",
            "Siparişiniz kargoya verildi. Takip: https://www.ptt.gov.tr/tr/hizmetler/kargo",
            "Faturam 250 TL gelmiş, bu ay ödeyeceğim.",
            "Teklifimiz hazır. İnceleyip dönünüz.",
            "Akbank mobil uygulamasını güncelledim, çok iyi olmuş.",
            "Garanti BBVA müşteri hizmetleri ile konuştum, sorun çözüldü.",
            "e-Devlet şifremi yeniliyorum: https://www.turkiye.gov.tr",
            "PTT kargo sorgulama: https://www.ptt.gov.tr",
            "SGK borcumu öğrendim, sorun yok.",
        ]
    ...
    def predict(self, text: str) -> Dict:
        ...
        url_risk = 0.0
        url_weights = {
            "has_suspicious_tld": 40.0, "has_shortener": 28.0,
            "has_brand": 35.0, "has_phishing_path": 30.0,
            "has_ip": 25.0, "has_redirect": 18.0,
        }
        ...
        if urf.get("url_length", 0) > 50:
            url_risk += 8.0
        # Kombinasyon: suspicous_tld + brand → cok guclu sinyal
        if urf.get("has_suspicious_tld", 0) > 0 and urf.get("has_brand", 0) > 0:
            url_risk = max(url_risk, 85.0)
        url_risk = min(url_risk, 95.0)
        
        # 3. Text-based scoring (aksan normalize edilmis metin uzerinde)
        text_norm = _normalize_tr(text_lower)
        text_score = 0.0
        keywords = [
            # Aksansiz
            ...
            "odeme", "islem", "cek", "aktivasyon",
            # Normalize edilmis Turkce aksanli karsiliklar
            "hesabiniz", "sifreniz", "kredi kart", "guvenlik",
            "tiklayin", "tiklayiniz", "hemen", "simdi", "acil",
            "kapatilacak", "kisitlanacak", "silinecek", "engellenecek",
            "dogrulama", "dogrulayin", "onay", "giris", "guncelle",
            "para", "ucret", "borc", "odenmemis", "gecikme",
        ]
        scam_keywords = [
            ...
            # Kripto scam
            "btc", "bitcoin", "kripto", "ethereum", "usdt",
            "aktivasyon ucreti", "cekim paneli", "yatirim odulu",
        ]
        invoice_scam_keywords = [
            ...
            # Kargo scam
            "gumruk ucreti", "teslimat ucreti", "isleme ucreti",
            "teslim edilemedi", "adres dogrulama", "kargo bekliyor",
        ]
        for kw in keywords:
            if kw in text_norm:
                text_score += 5.0
        ...
        for kw in invoice_scam_keywords:
            if kw in text_norm:
                text_score += 20.0
                result["identified_threats"].append(f"Fatura/kargo scam kelimesi tespit edildi: {kw}")
        ...
        urgent = ["acil", "hemen", "simdi", "tehlike", "uyari", "son gun", "son saat", "sure doluyor"]
        if any(k in text_norm for k in urgent):
            text_score += 12.0
        ...
        fear = ["kapatilacak", "engellenecek", "askiya", "bloke", "kisitli", "tehdit", "silinecek",
                "kisitlamaya", "iade edilecek", "yasal islem", "icra", "dava"]
        if any(k in text_norm for k in fear):
            text_score += 18.0
        ...
        auth = ["banka", "devlet", "guvenlik", "yetkili", "resmi", "musterimiz",
                "sgk", "ptt", "garanti", "akbank", "ziraat", "vakifbank"]
        if any(k in text_norm for k in auth):
            text_score += 8.0
