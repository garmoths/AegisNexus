...
import { MapPin, AlertTriangle, BrainCircuit } from 'lucide-react'
    ...
    <div style={{ minHeight: '100vh', background: theme.bg }}>
      ...
      >
          ...
          <div style={{ flex: '1 1 500px' }}>
            <div style={{ display: 'flex', gap: 8, marginBottom: 12, flexWrap: 'wrap' }}>
              ...
              {c.region && (
                ...
                }}><MapPin size={11} style={{marginRight:4}}/>{c.region}</span>
              )}
            </div>
        ...
        {c.critical_warning && (
          <div style={{
            ...
            <AlertTriangle size={18} color={theme.danger} style={{flexShrink:0}}/>
            <div>
      ...
      <section style={{
        ...
        <h2 style={{ fontSize: 18, fontWeight: 600, color: theme.primary, margin: '0 0 16px' }}>
          <span style={{display:'flex',alignItems:'center',gap:7}}><BrainCircuit size={16}/> Gemini Korunma Kartı</span>
        </h2>
