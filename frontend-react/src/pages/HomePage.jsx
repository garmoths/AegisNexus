...
import { Map, Search, Globe } from 'lucide-react'
  ...
  return (
    <div style={{ minHeight: '100vh', background: theme.bg }}>
      ...
      <section style={{
        ...
        {[
          { to: '/atlas', Icon: Map, title: 'Vaka Atlası', desc: 'Tüm siber dolandırıcılık vakalarını keşfedin' },
          { to: '/analyze', Icon: Search, title: 'Analiz Aracı', desc: 'Yaşadığınız olayı AI ile analiz edin' },
          { to: '/harita', Icon: Globe, title: 'Tehdit Haritası', desc: 'İl bazılı vaka yoğunluğunu görün' },
        ].map((card, i) => (
          <motion.div
            key={card.to}
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            <Link to={card.to} style={{ textDecoration: 'none' }}>
              <div style={{
                ...
                <card.Icon size={32} color={theme.primary} style={{marginBottom:4}}/>
