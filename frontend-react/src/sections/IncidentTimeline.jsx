...
import { Radio, Brain, Shield, Zap, RotateCcw } from 'lucide-react'

const PHASE_ICONS = { Detect: Radio, Triage: Brain, Contain: Shield, Eradicate: Zap, Recover: RotateCcw }
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 8 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <span
              ...
              aria-hidden
            >
              {(() => { const PhaseIcon = PHASE_ICONS[step.phase] || Shield; return <PhaseIcon size={22} color={theme.primary} strokeWidth={1.5}/>; })()}
            </span>
            <div>
      ...
      <div style={{ maxWidth: 920, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <p style={{ color: theme.textMuted, maxWidth: 660, margin: '12px auto 0', lineHeight: 1.7 }}>
            NIST 800-61 uyumlu 5 aşamalı müdahale playbook'u; AI triyaj, otomatik izolasyon ve değiştirilemez kanıt zinciriyle saldırının ilk sinyalinden closure'a ortalama 18 dakikada ulaşılır.
          </p>
        </div>
